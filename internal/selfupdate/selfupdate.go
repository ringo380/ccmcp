...
//   - Cached result is older than the TTL (default 24h)
...
const (
	// FreshTTL is how long a cached check result is considered fresh.
...
//   - Refreshes the cache when stale (network call with 2s cap)
